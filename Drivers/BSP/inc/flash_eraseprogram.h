 ...
 * @retval None
 */
#define FLASH_USER_START_ADDR_CONFIG   (FLASH_BASE + FLASH_PAGE_SIZE * 1280)        					/* Start @ of user Flash area store config (moved from 1200 to give 130KB firmware space) */
